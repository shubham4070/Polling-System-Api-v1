...
module.exports.listAll = async function(req, res){
    try{
        ...
        res.status(200).json({
            questionsCount: questions.length, // get the number of document
            questions: questions
        })
    }catch(error){
        res.status(500).json({
